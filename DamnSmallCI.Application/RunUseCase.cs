...
{
    public Aff<RT, Unit> Run(Environment environment, DirectoryInfo contextDirectory, FileInfo pipelineFile) =>
        ...
        from _10 in pipelineRunner.Run(outputProgress, environment, contextDirectory, pipeline)
        select unit;
}
